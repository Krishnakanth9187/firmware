...
int out_max = 10;
int out_min = 0;
double Kp = 2; // 0.3, 0.02
double Ki = 0.003;   // 2, 0.5
double Kd = 0.001; //0.1
double Kp1 = 2;   //0.1, 0.02
double Ki1 = 0.003;    //1.2
double Kd1 = 0.001;
double b;
double f;
double g;
...
void setup()
{
  ...
  servo2.attach(10);
  rmcs.Speed(slave_id1,0);
  rmcs.Speed(slave_id2,0);
...
double pid(double v,double u){
 ...
 // }
  ...
  PWM = mapFloat(PWM, 0.0, 1, out_min, out_max);
